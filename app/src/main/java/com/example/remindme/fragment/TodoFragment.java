...
public class TodoFragment  extends AbstractTabFragment {
    ...
    private List<RemindDTO> createMockRemindListData() {
        ...
        data.add(new RemindDTO("Test item 1 todo"));
        data.add(new RemindDTO("Test item 2 todo"));
        data.add(new RemindDTO("Test item 3 todo"));
        data.add(new RemindDTO("Test item 4 todo"));
        data.add(new RemindDTO("Test item 5 todo"));
        data.add(new RemindDTO("Test item 6 todo"));
        data.add(new RemindDTO("Test item 7 todo"));
